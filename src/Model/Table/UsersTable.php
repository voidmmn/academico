...
class UsersTable extends Table
{
    ...
    public function buildRules(RulesChecker $rules): RulesChecker
    {
        ...
        $rules->add($rules->existsIn(['courses_id'], 'Courses'), ['errorField' => 'courses_id']);
        $rules->add($rules->existsIn(['schools_id'], 'Schools'), ['errorField' => 'schools_id']);
