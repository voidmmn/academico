...
if (!Configure::read('debug')) :
    throw new NotFoundException(
        'Substitua templates/Pages/home.php por sua própria versão ou reative o modo de depuração.'
    );
endif;

$academicDescription = 'UEMG - Unidade Ituiutaba';
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <header>
        <div class="container text-center">
            <a href="https://cakephp.org/" target="_blank" rel="noopener">
                <img alt="CakePHP" src="./img/2021_Ituiutaba.png" width="250" />
            </a>
